...
import { Users, FileText, CheckCircle, AlertCircle, Clock, Calendar, Building2 } from "lucide-react";
...
export default function HRDashboard() {
    ...
    const [stats, setStats] = useState({ totalEmployees: 0, totalLeaves: 0 });
        ...
        const fetchStatsAndNotices = async () => {
            try {
                ...
                if (dashRes.ok) {
                    ...
                    setStats({ totalEmployees: dashData.totalEmployees, totalLeaves: dashData.totalLeaves });
                }
                if (noticeRes.ok) {
    ...
    const { totalEmployees, totalLeaves } = stats;
                ...
                {isTeamView && hasManagementAccess ? (
                    <>
                        ...
                        <div style={{ backgroundColor: "white", padding: "1.5rem", borderRadius: "0.75rem", boxShadow: "0 1px 3px rgba(0,0,0,0.05)", border: "1px solid #e5e7eb", display: "flex", alignItems: "center", gap: "1rem" }}>
                            ...
                            <div>
                                ...
                                <p style={{ margin: "0.25rem 0 0 0", fontSize: "1.5rem", fontWeight: "bold", color: "#111827" }}>{totalLeaves} 건</p>
                            </div>
                        </div>
                    ...
                    <>
                        ...
                        <div style={{ backgroundColor: "white", padding: "1.5rem", borderRadius: "0.75rem", boxShadow: "0 1px 3px rgba(0,0,0,0.05)", border: "1px solid #e5e7eb", display: "flex", alignItems: "center", gap: "1rem" }}>
                            ...
                            <div>
                                <p style={{ margin: 0, fontSize: "0.85rem", color: "#6b7280", fontWeight: 500 }}>진행 중인 결재 (내 연차)</p>
                                <p style={{ margin: "0.25rem 0 0 0", fontSize: "1.5rem", fontWeight: "bold", color: "#111827" }}>0 건</p>
                            </div>
                        </div>
                    </>
                )}
